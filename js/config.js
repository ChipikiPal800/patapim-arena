export const CONFIG = {
    ...
    weapons: {
        pistol:  { name: "Pistol", damage: 18, fireRate: 0.20, range: 100, ammoPerMag: 15, reloadTime: 1.0, movementPenalty: 0, cost: 0, scopeZoom: 1.4, color: 0x2a2a32, recoilV: 0.018, recoilH: 0.006, pellets: 1 },
        assault: { name: "Assault Rifle", damage: 12, fireRate: 0.08, range: 120, ammoPerMag: 30, reloadTime: 1.2, movementPenalty: 6, cost: 50, scopeZoom: 1.6, color: 0x2a3038, recoilV: 0.014, recoilH: 0.010, pellets: 1 },
        sniper:  { name: "Sniper", damage: 100, fireRate: 1.20, range: 250, ammoPerMag: 5, reloadTime: 2.0, movementPenalty: 13, cost: 215, scopeZoom: 3.5, color: 0x303a30, recoilV: 0.060, recoilH: 0.012, pellets: 1 },
